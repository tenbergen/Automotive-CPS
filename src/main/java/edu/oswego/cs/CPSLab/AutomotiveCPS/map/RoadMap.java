...
public class RoadMap implements Serializable, Cloneable {
    ...
    public List<Roadpiece> toList() {
        ...
        System.out.println(anchor.getPrev().getPiece());
        System.out.println(anchor.getPiece());
        System.out.println(anchor.getNext().getPiece());

        Section iterator = anchor.getNext();
        while (iterator != null && iterator != anchor) {
            try {
                if (iterator.getPiece() != null) {
                    System.out.println(iterator.getPiece());
    ...
    public RoadMap getCopy() {
        RoadMap rm;
        try {
            rm = (RoadMap) this.clone();
