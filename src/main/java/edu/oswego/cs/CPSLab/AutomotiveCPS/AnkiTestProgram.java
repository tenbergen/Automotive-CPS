...
public class AnkiTestProgram {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        if (vehicles.isEmpty()) {
            ...
            v1.addMessageListener(LocalizationIntersectionUpdateMessage.class, liuh);
            LocalizationIntersectionUpdateMessage lium = new LocalizationIntersectionUpdateMessage();
            v1.sendMessage(lium);
...
//        System.exit(0);
    ...
    private static class LocalizationIntersectionUpdateHandler implements MessageListener<LocalizationIntersectionUpdateMessage> {
        
        @Override
        public void messageReceived(LocalizationIntersectionUpdateMessage t) {
